    ...
    return (
        ...
        >
            ...
            {documentIcon?(
                ...
                <Icon size={18} className="shrink-0 mr-2 h-[18px] w-[18px] text-muted-foreground"/>
            )}
            ...
            {isSearch&&(
                <kbd className="ml-auto pointer-events-none inline-flex h-5 
                 ...
                 text-[12px] font-mono font-medium text-muted-foreground opacity-100">
                ...
                <div className="ml-auto flex items-center gap-x-2">
                    <DropdownMenu>
                        ...
                        >
                            ...
                            <div className="text-base text-muted-foreground p-2">
